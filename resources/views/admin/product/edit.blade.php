...
@section('content')
    <div class="container-fluid white">
        ...
        <div class="row  ">
            <div class="col-md-11  ">
                {!! Form::model($product,['route'=>['admin.product.update',$product],'method'=>'put','files'=>true,'class'=>'form-horizontal','role'=>'form']) !!}
                <div class="form-group row">
                    {{Form::label('name',important('产品名称'),['class'=>'col-2 col-form-label'],false)}}
                    <div class="col-11">
                        {{Form::text('name',old('name'),['class'=>'form-control','placeholder'=>'标题'])}}
                ...
                <div class="form-group row">
                    {{Form::label('name',important('产品简介'),['class'=>'col-2 col-form-label'],false)}}
...
@push('javascript')
    ...
    @include('plugins.editor_md',['body'=>old('editor-markdown-doc',$product->body)])
    @include('plugins.many-upload',['obj'=>$medias])
@endpush
