...
@section('content')
    <div class="container-fluid white">
        ...
        <div class="row  ">
            <div class="col-md-8  ">
                {!! Form::model($menu,['route'=>['admin.menu.update',$menu],'method'=>'put','files'=>true,'class'=>'form-horizontal','role'=>'form']) !!}
                ...
                <div class="form-group row">
                    ...
                    <div class="col-10">
                        {{Form::select('parent_id',$menus,$menu->parent_id,['class'=>'form-control','onchange'=>'change(this)'])}}
                    </div>
                </div>
                <div class="form-group row">
                    {{Form::label('order','排序',['class'=>'col-2 col-form-label'])}}
                    <div class="col-10">
                        {{Form::number('order',$menu->order,['class'=>'form-control'])}}
                    </div>
                </div>
