...
@section('content')
    <div class="container-fluid white">
        ...
        <div class="row  ">
            <div class="col-md-8  ">
                {!! Form::model($permission,['route'=>['admin.permission.update',$permission],'method'=>'put','files'=>true,'class'=>'form-horizontal','role'=>'form']) !!}
                ...
                <div class="form-group row">
                    {{Form::label('name',important('路由'),['class'=>'col-2 col-form-label'],false)}}
                    <div class="col-10">
